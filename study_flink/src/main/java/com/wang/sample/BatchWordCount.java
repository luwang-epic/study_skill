...
/**
 * DataSet批处理api，以后版本将会废弃，flink更倾向于批流统一，使用流的api来处理（有界流）
 */
@Deprecated
public class BatchWordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSource<String> stringDataSource = executionEnvironment.readTextFile("file:///D:\\idea_project\\study_skill\\file\\flink\\wc.txt");
